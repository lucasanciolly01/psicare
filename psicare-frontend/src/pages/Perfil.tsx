        ...
        <div className="px-8 pb-8">
          ...
          <div className="relative -mt-16 mb-8 flex justify-center md:justify-start">
            <div className="relative group">
              ...
              <label className="absolute bottom-1 right-1 bg-primary text-white p-2 rounded-full cursor-pointer hover:bg-green-700 shadow-lg transition-all" title="Alterar foto">
                <Camera size={18} />
          ...
          {/* Formulário de Edição (O código que você enviou entra aqui) */}
